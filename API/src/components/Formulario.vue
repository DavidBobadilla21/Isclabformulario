<script>
import btn from '../components/btnSubmit.vue';
import text1 from '../components/InputTexto.vue';
import slider from '../components/InputSlider.vue';
import tarea from '../components/TextoTarea.vue';
            ...
            <form v-on:submit.prevent action="" class="space-y-4">
              ...
              <div id="Formulario 1" v-show:value="Mostrar1">
                <div>
                  ...
                  <text1 @info= " nombre1 " > David Bobadilla</text1>
